...
exports.handler = async (event) => {
  ...
  try {
    // Dynamically import Resend and React Email renderer
    ...
    // Import the OrderConfirmationEmail component
    const { default: OrderConfirmationEmail } = await import('../src/emails/OrderConfirmationEmail');

    // Render the React component to HTML
    const html = await renderAsync(OrderConfirmationEmail({ 
