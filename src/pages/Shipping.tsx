      ...
      <main className="pt-32 pb-20">
        <div className="container mx-auto px-6" ref={contentRef}>
          <header className="text-center mb-16 animate-item">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 uppercase tracking-tight">SHIPPING</h1>
            <div className="w-20 h-0.5 bg-omnis-white mx-auto mb-8"></div>
            <p className="text-omnis-lightgray max-w-2xl mx-auto">
              Information about our shipping policies, delivery times, and available options.
            </p>
          </header>
          ...
          <div className="max-w-3xl mx-auto space-y-12">
            <section className="animate-item">
              ...
              <div className="border-l-2 border-omnis-white pl-6 space-y-6">
                <div>
                  ...
                  <p className="text-omnis-lightgray mb-2">7-10 business days</p>
                  <p className="text-omnis-lightgray">Free for orders over $200, otherwise $15</p>
                </div>
                ...
                <div>
                  <h3 className="text-xl font-medium mb-2">Next Day Delivery</h3>
                  <p className="text-omnis-lightgray mb-2">Next business day (order before 12pm)</p>
            ...
            <section className="animate-item">
              ...
              <p className="text-omnis-lightgray mb-4">
                We currently ship to over 40 countries worldwide. International shipping times vary by destination:
              </p>
              ...
              <p className="mt-4 text-omnis-lightgray">
                Please note that customs duties and taxes are not included in the shipping cost and are the responsibility of the customer.
              </p>
            </section>
            ...
            <section className="animate-item">
              ...
              <p className="text-omnis-lightgray mb-4">
                ...
                You can use this number to track your package through our shipping partner's website.
              </p>
              <p className="text-omnis-lightgray">
                For any questions regarding your shipment, please contact our customer service team at support@omnis.com.
              </p>
            </section>
          </div>
        </div>
