        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-omnis-lightgray max-w-2xl mx-auto">
              Information regarding our terms of service, privacy practices, and
              other policies. We are committed to transparency and protecting
          ...
          <motion.div
            ...
            animate={
              isContentInView ? { y: 0, opacity: 1 } : { y: 30, opacity: 0 }
            }
            ...
            <Tabs defaultValue="terms" className="w-full">
              ...
              >
                <section>
                  ...
                  <p>
                    Welcome to OMNIS. By accessing or using our website, mobile
                    application, or any of our services, you agree to be bound
                    by these Terms of Service. Please read these terms carefully
                ...
                <section>
                  ...
                  <p>
                    ...
                    Prices are subject to change without notice. By making a
                    purchase, you agree to pay the specified amount in full. We
                    accept various payment methods as indicated during checkout.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p>
                    We ship to the locations listed on our Shipping Information
                    page. Delivery times are estimates and not guaranteed. OMNIS
                    is not responsible for delays due to customs, weather, or
                ...
                <section>
                  ...
                  <p>
                    ...
                    button icons, images, audio clips, digital downloads, and
                    data compilations, is the property of OMNIS or its content
                ...
                <section>
                  ...
                  <p>
                    To the fullest extent permitted by law, OMNIS shall not be
                    liable for any indirect, incidental, special, consequential,
                    or punitive damages, including lost profits, arising out of
              ...
              >
                <section>
                  ...
                  <p>
                    ...
                    information (such as name, email address, shipping address,
                    and payment information) and non-personal information (such
                    as browser type, IP address, and device information).
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p>
                    We use the information we collect to process transactions,
                    provide and improve our services, communicate with you, and
                    comply with legal obligations. We may also use your
                    information for marketing purposes, but you can opt out at
                    any time.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p>
                    ...
                    assist us in operating our business, as required by law, or
                    with your consent.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p>
                    ...
                    deliver personalized content. You can control cookies
              ...
              >
                <section>
                  ...
                  <p>
                    ...
                    All items must be unworn, unwashed, and in their original
                    condition with all tags attached. Items marked as "Final
                    Sale" are not eligible for return or exchange.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p>
                    To initiate a return, please log into your account and
                    follow the return instructions, or contact our customer
                    service team. You will receive a return authorization and
                ...
                <section>
                  ...
                  <p>
                    ...
                    item. If approved, your refund will be processed to the
                    original method of payment within 10 business days.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p>
                    We do not process direct exchanges. If you wish to exchange
                    an item, please return it for a refund and place a new order
                    for the desired item. This ensures that the item you want is
                    still in stock.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p>
                    Customers in the United States receive a free return
                    shipping label. International customers are responsible for
                    return shipping costs and any customs duties or taxes
                    incurred during the return process.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p>
                    ...
                    our customer service team within 7 days of receiving your
                    order. We will provide instructions for returning the item
                    and will cover all shipping costs for exchanges or returns
                    in this case.
                  </p>
                </section>
              ...
              >
                <section>
                  ...
                  <p>
                    OMNIS is committed to making our website accessible to all
                    users, including those with disabilities. We are
                    continuously working to improve the accessibility of our
                    website to ensure we provide equal access to all of our
                    customers.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p>
                    We strive to conform to level AA of the World Wide Web
                    Consortium (W3C) Web Content Accessibility Guidelines 2.1.
                    These guidelines explain how to make web content more
                    accessible for people with disabilities and more
